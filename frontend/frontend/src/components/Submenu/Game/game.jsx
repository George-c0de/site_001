...
//Logout
        ...
        const getSix = async ()=>{
            await axios.get('https://1ba8-176-193-182-242.eu.ngrok.io/api/six')
                .then((data) => {
                    const result = {
        ...
        const getCard = async () => {
            await axios.get('https://1ba8-176-193-182-242.eu.ngrok.io/api/get_user_in_matrix')
                .then((data) => {
                    const result = {
                        bronze: data.data.bronze,
                        silver: data.data.silver,
        ...
        let getUsername = async () => {
            const username = await axios.get('https://1ba8-176-193-182-242.eu.ngrok.io/api/user')
            setUsername(username.data.username);
        }
        let getHist = async () => {
            await axios.get('https://1ba8-176-193-182-242.eu.ngrok.io/api/get_hist_card')
                .then((data) => {
                    const result = {
                        oneq: data.data.oneq,
                        two: data.data.two,
        ...
        let getCard_data = async () => {
            await axios.get('https://1ba8-176-193-182-242.eu.ngrok.io/api/get_user_in_card')
                .then((data) => {
                    const result = {
                        bronze: data.data.bronze,
                        silver: data.data.silver,
