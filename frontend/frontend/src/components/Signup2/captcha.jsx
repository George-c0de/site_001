...
//Generate string of captcha
  ...
  return (
    <div className="captcha-wrapper">
      <input type="text" id="inputType" className="input" placeholder="Enter Captcha"
             name="usercaptname" onChange={ handleChange } autoComplete="off"
      />

      <div className='captcha-field'>
        <img src={ captchaImg } className="captcha-image" alt=""/>
        <h4 id="captcha" className="captcha-data">{ captcha }</h4>
      </div>
